  ...
  const fetchDashboardStats = async () => {
    try {
      ...
      if (response.ok) {
        ...
        const totalRatings = videos.reduce((sum: number, video: any) => sum + parseFloat(video.average_rating) * video.rating_count, 0);
        const ratingCount = videos.reduce((sum: number, video: any) => sum + video.rating_count, 0);
  ...
  return (
    <div className="max-w-7xl mx-auto">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-400 mt-2">Here's how your content is performing</p>
      </div>
